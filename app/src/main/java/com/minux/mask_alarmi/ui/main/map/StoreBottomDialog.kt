...
class StoreBottomDialog(
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialog.setOnShowListener {
            ...
            val bottomSheet =
                bottomSheetDialog.findViewById<View>(design_bottom_sheet) as FrameLayout?
    ...
    private fun initViews(view: View) {
        ...
        view.findViewById<ImageView>(R.id.store_bt_dialog_iv_stock_state).setImageResource(
            when (store.remainState) {
        ...
        store.stockAt?.let {
            view.findViewById<TextView>(R.id.store_bt_dialog_tv_stock_time).text =
                "${it.substring(5, 7)}.${it.substring(8, 10)} ${it.substring(11, 16)}"
        }
    }
